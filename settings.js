...
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=CzpQHCaI#3vewfEljkr6mrz2sO_UqUqMNwBblriJJkhtvkZ0FRyM' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
PORT: process.env.PORT === undefined ? "8000" : process.env.PORT,
SUDO: process.env.SUDO === undefined ? '94728786936' : process.env.SUDO,
SESSION_NAME: process.env.PORT === undefined ? "sithu" : process.env.SESSION_NAME,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*Hello , I am hacker sithu!!*" : process.env.ALIVE_MSG,
